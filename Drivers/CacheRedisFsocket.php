...
class CacheRedisFsocket implements CacheInterface
{
    ...
    /**
     * Кроме отчёта, статус Redis содержит количество байт хранимого объекта или -1 в случае ошибки.
     * Данная функция извлекает количество байт из статуса, если это возможно
